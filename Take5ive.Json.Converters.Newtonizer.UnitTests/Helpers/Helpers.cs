...
namespace Take5ive.Json.Converters.UnitTests
{
    internal static class Helpers
    {
        ...
        public static bool HasIncludeNullAttribute(PropertyInfo property)
        {
            return property.GetCustomAttribute<JsonPropertyAttribute>()?.NullValueHandling == NullValueHandling.Include;
        }

        /// <summary>
        /// Check to see if property has a JsonProperty attribute to ignore null values
        /// </summary>
        /// <param name="property">Property to check</param>
        /// <returns>Boolean decision</returns>
        public static bool HasIgnoreNullValueAttribute(PropertyInfo property)
        {
            return property.GetCustomAttribute<JsonPropertyAttribute>()?.NullValueHandling == NullValueHandling.Ignore;
        }
